...
import CardFooter from './Component/Card/CardFooter/CardFooter.component';
...
const store = createStore(libraryApp, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
